...
public class BlockFragmentedWaterCrystal extends Block {
    public BlockFragmentedWaterCrystal() {
        super(BlockBehaviour.Properties.of(Material.ICE_SOLID).strength(1.5f));
    }

    @Override
    public List<ItemStack> getDrops(BlockState p_60537_, LootContext.Builder p_60538_) {
        List<ItemStack> drops = new ArrayList<>();
        drops.add(new ItemStack(ModItem.FRAGMENTED_WATER_CRYSTAL.get(),RANDOM.nextInt(2)+1));
        return drops;
    }
    ...
    public InteractionResult use(BlockState p_60503_, Level p_60504_, BlockPos p_60505_, Player p_60506_, InteractionHand p_60507_, BlockHitResult p_60508_) {
        if (p_60506_.getMainHandItem().getItem() != Items.AIR){
            if (p_60506_.getMainHandItem().getItem() == fr.iglee42.techresourcesbase.init.ModItem.LAVA_SHARD.get()) {
                p_60504_.setBlockAndUpdate(p_60505_, ModBlock.FRAGMENTED_WATER_CRYSTAL_CORE.get().defaultBlockState());
